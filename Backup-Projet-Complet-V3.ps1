...
$ProjectPath = "D:\PROJET-NODEJS\site1-paroisse-saint-paul-corbeil-master\!RACINE-DEV\paroisse-saint-paul-corbeil"
$BackupPath = "D:\PROJET-NODEJS\BACKUP\site1-paroisse-saint-paul-corbeil-master\Complet"
...
$Txt += "- **Script** : Backup-Projet-Complet v3.0`r`n"
$Txt += "`r`n"
$Txt += "---`r`n"
$Txt += "`r`n"
